...
export class PosController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Array of POS terminals.',
    type: [PosTerminal],
  })
  ...
  @Get('active')
  @ApiOperation({
    summary: 'List active POS terminals for the branch (waiter dropdown)',
  })
  @ApiResponse({
    status: 200,
    description: 'Array of active POS terminals.',
    type: [PosTerminal],
  })
  @ApiResponse({ status: 401, description: 'Unauthorized.' })
  ...
  @ApiResponse({
    status: 200,
    description: 'POS terminal record.',
    type: PosTerminal,
  })
