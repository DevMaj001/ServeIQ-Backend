...
export class AuditController {
  ...
  @ApiQuery({ name: 'entity_id', required: false, description: 'Filter by entity UUID' })
  @ApiQuery({ name: 'date_from', required: false, description: 'Start date (ISO string)' })
  @ApiQuery({ name: 'date_to', required: false, description: 'End date (ISO string)' })
