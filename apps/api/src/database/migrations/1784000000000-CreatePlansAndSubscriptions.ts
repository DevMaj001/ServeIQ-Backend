...
export class CreatePlansAndSubscriptions1784000000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'billing_interval_enum') THEN CREATE TYPE "public"."billing_interval_enum" AS ENUM('monthly', 'yearly'); END IF; END $$`);
        await queryRunner.query(`DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'subscriptions_status_enum') THEN CREATE TYPE "public"."subscriptions_status_enum" AS ENUM('trialing', 'active', 'past_due', 'canceled', 'expired'); END IF; END $$`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX IF NOT EXISTS "IDX_subscriptions_branch_id" ON "subscriptions" ("branch_id")`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_subscriptions_plan_id" ON "subscriptions" ("plan_id")`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_subscriptions_paystack_customer_code" ON "subscriptions" ("paystack_customer_code")`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_subscriptions_paystack_subscription_code" ON "subscriptions" ("paystack_subscription_code")`);

        await queryRunner.query(`ALTER TABLE "subscriptions" ADD CONSTRAINT "FK_subscriptions_branch_id" FOREIGN KEY ("branch_id") REFERENCES "branches"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "subscriptions" DROP CONSTRAINT IF EXISTS "FK_subscriptions_plan_id"`);
        await queryRunner.query(`ALTER TABLE "subscriptions" DROP CONSTRAINT IF EXISTS "FK_subscriptions_branch_id"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_subscriptions_paystack_subscription_code"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_subscriptions_paystack_customer_code"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_subscriptions_plan_id"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_subscriptions_branch_id"`);
        await queryRunner.query(`DROP TABLE IF EXISTS "subscriptions"`);
        await queryRunner.query(`DROP TABLE IF EXISTS "plans"`);
        await queryRunner.query(`DROP TYPE IF EXISTS "public"."subscriptions_status_enum"`);
        await queryRunner.query(`DROP TYPE IF EXISTS "public"."billing_interval_enum"`);
    }
}
