...
export class StandardizeUuidTypes1782053106763 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_0eddfeffadbe29bec8750d589c"`);
        await queryRunner.query(`ALTER TABLE "bills" DROP COLUMN IF EXISTS "tab_id"`);
        await queryRunner.query(`ALTER TABLE "bills" ADD "tab_id" uuid`);
        await queryRunner.query(`DELETE FROM "bills" WHERE "tab_id" IS NULL`);
        await queryRunner.query(`ALTER TABLE "bills" ALTER COLUMN "tab_id" SET NOT NULL`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_29171753dda776dfb0037dba05"`);
        await queryRunner.query(`ALTER TABLE "menu_items" DROP COLUMN IF EXISTS "branch_id"`);
        await queryRunner.query(`ALTER TABLE "menu_items" ADD "branch_id" uuid`);
        await queryRunner.query(`DELETE FROM "menu_items" WHERE "branch_id" IS NULL`);
        await queryRunner.query(`ALTER TABLE "menu_items" ALTER COLUMN "branch_id" SET NOT NULL`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_03ef7c5c41b4fa6d62d27d47f4"`);
        await queryRunner.query(`ALTER TABLE "orders" DROP COLUMN IF EXISTS "tab_id"`);
        ...
        await queryRunner.query(`ALTER TABLE "orders" ALTER COLUMN "tab_id" SET NOT NULL`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_6290f6ba23d55826e9deaceee5"`);
        await queryRunner.query(`ALTER TABLE "orders" DROP COLUMN IF EXISTS "menu_item_id"`);
        await queryRunner.query(`ALTER TABLE "orders" ADD "menu_item_id" uuid`);
        await queryRunner.query(`DELETE FROM "orders" WHERE "menu_item_id" IS NULL`);
        await queryRunner.query(`ALTER TABLE "orders" ALTER COLUMN "menu_item_id" SET NOT NULL`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_4d5057e0cdbd1407b60216df6e"`);
        await queryRunner.query(`ALTER TABLE "tabs" DROP COLUMN IF EXISTS "branch_id"`);
        ...
        await queryRunner.query(`ALTER TABLE "tabs" ALTER COLUMN "branch_id" SET NOT NULL`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_1e4fa66a2d59fde6dbb07fb13a"`);
        await queryRunner.query(`ALTER TABLE "tabs" DROP COLUMN IF EXISTS "table_id"`);
        ...
        await queryRunner.query(`ALTER TABLE "tabs" ALTER COLUMN "table_id" SET NOT NULL`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_2b477b0f678402fb70905e3aed"`);
        await queryRunner.query(`ALTER TABLE "tabs" DROP COLUMN IF EXISTS "waiter_id"`);
        ...
        await queryRunner.query(`ALTER TABLE "tabs" ALTER COLUMN "waiter_id" SET NOT NULL`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_ebe158ed365131baec7dccaae5"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_283e6bfdd38a7cc7fec643f72b"`);
        await queryRunner.query(`ALTER TABLE "tables" DROP COLUMN IF EXISTS "branch_id"`);
        ...
        await queryRunner.query(`ALTER TABLE "tables" ALTER COLUMN "branch_id" SET NOT NULL`);
